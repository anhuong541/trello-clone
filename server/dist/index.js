...
app.get("/project", project_1.ProjectListHandler);
app.post("/project", project_1.AddProjectHandler);
app.put("/project", project_1.EditProjectHandler);
app.delete("/project/:projectId", project_1.DeleteProjectHandler);
app.get("/task/:projectId", task_1.ViewTasksHandler);
app.post("/task", task_1.CreateTaskHandler);
app.put("/task", task_1.UpdateTaskHandler);
app.delete("/task/:projectId/:taskId", task_1.DeleteTaskHandler);
app.listen(port, () => {
