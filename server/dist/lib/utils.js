...
exports.readUserIdFromAuthorization = exports.checkUIDAndProjectExists = exports.generateUidByString = exports.generateNewUid = void 0;
...
const readUserIdFromAuthorization = (req) => {
    var _a;
    const token = (_a = req === null || req === void 0 ? void 0 : req.headers.authorization.split(" ")[1]) !== null && _a !== void 0 ? _a : ""; // send at the client
    const { email } = jsonwebtoken_1.default.verify(token, config_1.default.jwtSecret);
    return (0, exports.generateUidByString)(email);
};
exports.readUserIdFromAuthorization = readUserIdFromAuthorization;
